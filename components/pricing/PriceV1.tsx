...
import pricingNavbar from "@/public/assets/images/pricing-navbar.svg";
import pricingShape1 from "@/public/assets/images/pricing-shape1.png";
import pricingShape2 from "@/public/assets/images/pricing-shape2.png";
import btnArrow from "@/public/assets/images/btn-arrow.svg";
import featuredIcon from "@/public/assets/images/featured-icon.svg";
      ...
      <div className="pricing-sec" id="pricing">
        <div className="custom-container">
          <div className="section-header section-header2">
            <SecSubTitle img={Union} text="PRICING PLANS" />
            <h2 className="section-title section-title2">
              Flexible Plans, <span>Powerful Results</span>
            </h2>
            <p className="section-desc">
              {`Whether you're a startup looking for a boost or an established brand aiming to elevate your presence,`}
              <br />
          ...
          <div className="pricing_nav_wrap">
            <ul
              className="pricing_nav nav-tabs"
              id="myTab"
              role="tablist"
              ref={navRef}
            >
            ...
            <span
              className="nav-hover-shape"
              ref={indicatorRef}
              style={{ left: 439, opacity: 1 }}
            >
              ...
              <div className="pricing-lists">
                ...
                <div className="pricing-box" data-aos="fade-up">
                  <div className="pricing-header">
                    ...
                    <p className="content">
                      <span className="required">*</span> Ideal for growing
