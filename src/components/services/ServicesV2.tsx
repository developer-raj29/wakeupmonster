      ...
      <div className="service-sec service-sec-2" id="services">
        <div className="custom-container">
          <div className="section-header">
            <SecSubTitle img={Union} text={"OUR VALUES"} />
            <AnimatedText>
              We firmly believe in the transformation power of honesty and
              transparency. These values support our ability to create
              exceptional and meaningful work that sparks inspiration.
            </AnimatedText>
          </div>
        </div>
